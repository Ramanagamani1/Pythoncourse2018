...
-how to handle exceptions using try and except block
-try else clause is executed when no exception rises in try block
-and also finally block will be executed even if exception rises or not and also how to handle nested exceptions
"""
