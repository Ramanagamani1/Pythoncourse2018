...
-the usage of dictionary and keys cannot be lists as keys are unique,but values can be of any type
-they are indexed by keys,unordered
-zip() usage,keys,values,items
"""
