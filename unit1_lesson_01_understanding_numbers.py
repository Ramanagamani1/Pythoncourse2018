...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=0.033), "fix abs_tol so that this assert passes"
...
#           http://courses.cs.vt.edu/~cs1104/number_conversion/convexp.htmlt.
...
notes2 = '''
Rinish the lesson for more details on python numeric types: 
ead this after you fhttps://docs.python.org/3/library/stdtypes.html#typesnumeric
'''

three_things_i_learnt = """
- modulo operator with negative numbers
- using // for getting quotient
- using built in functions hex,oct and int.__doc__
"""