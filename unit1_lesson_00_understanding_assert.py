...
def test_assert_true_with_message():
    print("test print")
    assert "This is the failure message" # what error do you see when you run this test?
...
-the meaning of assert ie if condition is true it continues ,if not it raises an assertion error
-the ** symbol is used for power function
-
"""