...
def test_string_formatting_literals():
    ...
    The full details are at:, read it to get an idea of how a feature
...
-about slicing,combining
-formatting,membership function,rawstrings
-string methods like capitalize,zfill etc
"""
